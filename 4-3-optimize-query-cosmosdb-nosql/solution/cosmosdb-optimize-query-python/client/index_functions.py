...
#     query = """
#         SELECT TOP @topN
#             c.id, c.documentId, c.content, VectorDistance(c.embedding, @queryEmbedding)
#         FROM c
...
#     ru_charge = 0.0
#     try:
#         ru_charge = float(container.client_connection.last_response_headers.get("x-ms-request-charge", 0))
#     except Exception as e:
#         pass
